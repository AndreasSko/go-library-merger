...
func Test_MergeLocationsNonTableTest(t *testing.T) {
	left := []*model.Location{
		...
		},
		{
			...
			DocumentID:     sql.NullInt64{Int64: 2020401, Valid: true},
			Track:          sql.NullInt32{},
			IssueTagNumber: 0,
		...
		},
		{
			...
			BookNumber:     sql.NullInt32{},
			ChapterNumber:  sql.NullInt32{},
			DocumentID:     sql.NullInt64{Int64: 2020501, Valid: true},
			Track:          sql.NullInt32{},
			IssueTagNumber: 0,
			KeySymbol:      sql.NullString{String: "w", Valid: true},
			MepsLanguage:   sql.NullInt32{Int32: 2, Valid: true},
	...
	right := []*model.Location{
		...
		},
		{
			...
			BookNumber:     sql.NullInt32{},
			ChapterNumber:  sql.NullInt32{},
			DocumentID:     sql.NullInt64{Int64: 123456789, Valid: true},
			Track:          sql.NullInt32{},
			IssueTagNumber: 0,
		...
		},
		{
			...
			BookNumber:     sql.NullInt32{},
			ChapterNumber:  sql.NullInt32{},
			DocumentID:     sql.NullInt64{Int64: 123456790, Valid: true},
			Track:          sql.NullInt32{},
			IssueTagNumber: 0,
			KeySymbol:      sql.NullString{String: "CO-pgm20", Valid: true},
			MepsLanguage:   sql.NullInt32{Int32: 2, Valid: true},
	...
	tests := []struct {
	...
	}{
		{
			...
			left: []*model.Location{
				...
				{
					LocationID:     1,
					DocumentID:     sql.NullInt64{Int64: int64(123), Valid: true},
					IssueTagNumber: 0,
		...
		{
			name: "Different Specialty treated as distinct locations",
			left: []*model.Location{
				nil,
				{
					LocationID:     1,
					DocumentID:     sql.NullInt64{Int64: 42, Valid: true},
					IssueTagNumber: 0,
					KeySymbol:      sql.NullString{String: "nwtsty", Valid: true},
					MepsLanguage:   sql.NullInt32{Int32: 2, Valid: true},
					LocationType:   0,
		...
		{
			name: "Same Specialty deduplicated",
			left: []*model.Location{
				nil,
				{
					LocationID:     1,
					...
					LocationType:   0,
					Specialty:      sql.NullString{String: "E", Valid: true},
					Title:          sql.NullString{String: "Left title", Valid: true},
				},
			},
			right: []*model.Location{
				nil,
