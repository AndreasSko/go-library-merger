			...
			args: args{
				merged: &model.Database{
					...
					Location: []*model.Location{
						...
						{
							LocationID: 1,
							DocumentID: sql.NullInt64{6789, true},
							KeySymbol:  sql.NullString{"nwtsty", true},
						},
						{
							LocationID: 2,
		...
		},
		{
			...
			args: args{
				...
				left: []*model.Location{
					...
					{KeySymbol: sql.NullString{"nwtsty", true}, MepsLanguage: sql.NullInt32{Int32: 0, Valid: true}},
					{KeySymbol: sql.NullString{"nwt", true}, MepsLanguage: sql.NullInt32{Int32: 0, Valid: true}},
					{DocumentID: sql.NullInt64{1, true}, KeySymbol: sql.NullString{"nwtsty", true}, MepsLanguage: sql.NullInt32{Int32: 1, Valid: true}},
				...
				right: []*model.Location{
					...
					{KeySymbol: sql.NullString{"nwt", true}, MepsLanguage: sql.NullInt32{Int32: 1, Valid: true}},
					{KeySymbol: sql.NullString{"nwtsty", true}, MepsLanguage: sql.NullInt32{Int32: 0, Valid: true}},
					{DocumentID: sql.NullInt64{1, true}, KeySymbol: sql.NullString{"nwt", true}, MepsLanguage: sql.NullInt32{Int32: 1, Valid: true}},
